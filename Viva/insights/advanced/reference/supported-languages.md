...
* .csv files generated by Viva Insights are UTF-8 encoded. Excel doesn't automatically use UTF-8 when opening .csv files, which might cause garbled characters. Refer to [Access query results and modify existing queries](../analyst/query-results.md) to learn how to import a .csv file in Excel.
