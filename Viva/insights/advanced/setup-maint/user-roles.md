...
| Function | Insights Administrator | Insights Analyst | Manager | 
|---|---|--|---|
| Configure privacy settings, partitions, and manager settings | X | | |
| Upload organizational data into the system | X | | |
| Access organization insights within the Viva Insights app  | | | X|
...
| Access level | Insights Administrator | Insights Analyst  | Manager |
|---|---|--|---|
...
| Persona | Insights Administrator | Insights Analyst  | Manager |
|---|---|--|---|
| Administrator | X | | |
