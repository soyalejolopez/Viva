...
description: The Microsoft Viva Glint 360 Feedback program and process give insight into a manager's strengths and opportunities with a specific, long-term focus.
...
|**Program**|A program contains at least one 360 cycle. A program could, however, include cycles focusing on a specific program theme. The number of 360 programs you can set is unlimited.|
|**Cycle**|A single and specific Viva Glint 360 feedback program. Each program must have at least one cycle.|
