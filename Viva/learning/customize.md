...
We recommended that you also apply app settings that [prepin and preinstall the app](/microsoftteams/teams-app-setup-policies) to make sure people in your organization can more easily find it.
...
- As an application in the App Store
- If the app is pinned on Teams
...
- The new app icon and app name don't display in Viva interconnections.
- The application header isn't changed in either desktop, web, or mobile.
- The new app icon or app name doesn't display in the global navigation.
- The Viva Learning web app doesn't reflect any of these branding chances as our current scope is the Teams application manifest.
