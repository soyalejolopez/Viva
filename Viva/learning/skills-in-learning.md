...
- Any tags manually added to the content before the current preview not in en-US are lost. Follow these steps to [retain your current en-US interests as skills](#retain-your-current-interests-as-skills).
...
> [!NOTE] 
> Skills that aren't en_US are lost.
...
Any tags that were manually added to content prior to the current preview are lost if they aren't in en-US. Follow these steps to [retain your current en-US interests as skills.](#retain-your-current-interests-as-skills)
...
> [!NOTE]
> Autogenerated tags for new content ingested into Viva Learning are periodically added. Autogenerated tags for the entire catalog aren't refreshed periodically.
