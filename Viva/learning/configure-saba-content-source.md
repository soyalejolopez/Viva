...
1. On the same screen where you got the host URL, copy the Client ID and Client Secret if they're already generated.
...
7. Once configured, Saba start appearing automatically in configured providers list. You can track the sync status and export sync log. 
